...
module.exports = {
  ...
  create(context) {
    return context.parserServices.defineTemplateBodyVisitor({
      ...
      "VElement > VStartTag"(elem) {},
      "VElement > VEndTag"(elem) {
        currentId = undefined;
      },
      ...
      //all with simple bindings. TODO might not be the most stable way to check
      "VElement > VExpressionContainer >Identifier"(node) {
